...
public final class Forge1201AboutScreen extends Screen {
  ...
  @Override public void tick() {
    super.tick();
    // Consume the common controller's route on the target shell so the visible Back button
    // navigates exactly like ESC instead of leaving the About screen in place.
  ...
  @Override public boolean mouseClicked(double mouseX, double mouseY, int button) {
    AboutLayout.Layout layout = AboutLayout.calculate(width, height,
        new Forge1201UiTextMetrics(font), 1.0f);
