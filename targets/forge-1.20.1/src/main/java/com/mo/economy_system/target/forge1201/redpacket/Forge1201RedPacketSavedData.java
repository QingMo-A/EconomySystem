...
/** Forge NBT persistence adapter for common red-packet snapshots. */
public final class Forge1201RedPacketSavedData extends SavedData {
  ...
  public static Forge1201RedPacketSavedData load(CompoundTag tag) {
  ...
  public static Forge1201RedPacketSavedData getInstance(ServerLevel level) {
    ServerLevel overworld = level.getServer().getLevel(Level.OVERWORLD);
    if (overworld == null) throw new IllegalStateException("Overworld is not loaded");
    return overworld.getDataStorage().computeIfAbsent(
        Forge1201RedPacketSavedData::load, Forge1201RedPacketSavedData::new, DATA_NAME);
  }
