...
final class Forge1201DemandMailboxBridge
  ...
  Forge1201DemandMailboxBridge(ServerPlayer supplier) {
  ...
  public DemandMailboxResult preflight(UUID requesterId, Object template, int quantity) {
    ...
    try {
      ...
      Forge1201MailboxSavedData mailbox = Forge1201MailboxSavedData.get(supplier.serverLevel());
      Forge1201DeliveryBoxSavedData delivery = Forge1201DeliveryBoxSavedData.get(supplier.serverLevel());
      ...
      LOGGER.error("Demand mailbox preflight failed requester={}", requesterId, error);
      return DemandMailboxResult.FAILED;
    }
  }
  ...
  public DemandOrderDeliveryService.MailboxStage stage(
    ...
    try {
      ...
      List<DeliveryBoxEntrySnapshot> attachments = snapshots(nativeTemplate, quantity, content.source());
  ...
  public DemandMailboxResult deliver(
    ...
    try {
      ...
      try {
        ...
        LOGGER.warn("Admin sales removal mail notification failed owner={}", ownerId,
            notificationFailure);
      }
      return DemandMailboxResult.SUCCESS;
    } catch (IllegalStateException full) {
  ...
  private final class StagedDelivery implements DemandOrderDeliveryService.StagedMailboxDelivery {
    ...
    private final Forge1201MailboxSavedData mailbox;
    private final Forge1201DeliveryBoxSavedData delivery;
    ...
    private StagedDelivery(
        ...
        Forge1201MailboxSavedData mailbox,
    ...
    public void commit() {
      ...
      try {
        ...
        LOGGER.warn("Demand mailbox notification failed requester={}", requesterId, notificationFailure);
      }
    }
    ...
    public DemandMailboxResult rollback() {
      ...
      try {
        ...
        LOGGER.error("Demand staged-mail metadata rollback failed requester={} mail={}",
      ...
      if (attachmentRollback != DemandMailboxResult.SUCCESS) {
        try {
          ...
          LOGGER.error("Demand staged-mail rollback could not restore metadata requester={} mail={}",
  ...
  private static DemandMailboxResult rollbackAttachments(
      Forge1201DeliveryBoxSavedData delivery, UUID requesterId, Set<UUID> attachmentIds) {
    try {
  ...
  private List<DeliveryBoxEntrySnapshot> snapshots(
    ...
    while (remaining > 0) {
      ...
      var snapshot = Forge1201Platform.nativeItemStacks()
          .captureSnapshot(stack, supplier.serverLevel().registryAccess())
          .orElseThrow();
