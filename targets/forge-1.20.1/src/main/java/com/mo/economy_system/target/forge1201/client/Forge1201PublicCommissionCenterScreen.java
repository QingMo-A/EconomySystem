...
/** Forge widget shell for the common public commission center. */
public final class Forge1201PublicCommissionCenterScreen extends Screen {
  ...
  public Forge1201PublicCommissionCenterScreen() { this(null); }
  public Forge1201PublicCommissionCenterScreen(Screen parent) {
  ...
  @Override protected void init() {
    ...
    amount = new Forge1201UnderlinedEditBox(font,
    ...
    Forge1201UiInputAdapter.apply(amount);
  ...
  @Override public void onClose() {
    if (minecraft != null) minecraft.setScreen(parent != null ? parent : new Forge1201HomeScreen());
  }
