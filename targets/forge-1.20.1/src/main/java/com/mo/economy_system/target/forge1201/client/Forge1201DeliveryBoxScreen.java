...
/** Forge Screen shell for the loader-neutral delivery-box page. */
public final class Forge1201DeliveryBoxScreen extends Screen {
  ...
  @Override public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
    ...
    DeliveryView.render(new Forge1201UiRenderer(graphics, font), controller.state(), layout,
  ...
  @Override public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
    if (delta != 0 && controller.state().totalPages() > 1) {
      controller.handle(new DeliveryEvent.Scroll(delta < 0 ? 1 : -1));
      return true;
    }
