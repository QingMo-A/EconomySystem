...
/** Forge Screen shell for the common balance-log table. */
public final class Forge1201BalanceLogScreen extends Screen {
  ...
  public Forge1201BalanceLogScreen() { this(null); }
  public Forge1201BalanceLogScreen(Screen parent) {
  ...
  @Override public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
    if (delta != 0) { controller.handle(new BalanceLogEvent.Scroll(delta < 0 ? 1 : -1)); return true; }
