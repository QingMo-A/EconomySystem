...
public class EnUsLanguageProvider extends LanguageProvider {
  ...
  protected void addTranslations() {
    ...
    // TPA Command | TPA指令
    add(TpaFeedback.SELF, "You cannot send a teleport request to yourself");
    add(TpaFeedback.NO_POTION, "You need a Wormhole Potion to send a teleport request");
    add(TpaFeedback.REQUEST_SENT, "Teleport request sent to %s");
    add(TpaFeedback.REQUEST_RECEIVED, "%s wants to teleport to you");
    add(TpaFeedback.ACCEPT, "Click to accept");
    add(TpaFeedback.ACCEPT_BUTTON, "[Accept]");
    add(TpaFeedback.DENY, "Click to deny");
    add(TpaFeedback.DENY_BUTTON, "[Deny]");
    add(TpaFeedback.NO_REQUEST, "No pending teleport request");
    add(TpaFeedback.SENDER_OFFLINE, "The teleport requester is offline");
    add(TpaFeedback.SENDER_NO_POTION, "%s no longer has a Wormhole Potion");
    add(TpaFeedback.TELEPORTED, "Teleported to %s");
    add(TpaFeedback.ACCEPTED, "You accepted %s's teleport request");
    add(TpaFeedback.DENIED_SENDER, "%s denied your teleport request");
    add(TpaFeedback.DENIED_TARGET, "Teleport request denied");
    add(TpaFeedback.TIMEOUT_SENDER, "Your teleport request to %s timed out");
    add(TpaFeedback.TIMEOUT_TARGET, "%s's teleport request timed out");
    add(TpaFeedback.TARGET_BUSY, "%s already has a pending teleport request");
    add(TpaFeedback.SENDER_BUSY, "You already have a pending teleport request");
    add(TpaFeedback.CAPACITY, "The server has too many pending teleport requests");
    add(TpaFeedback.INVENTORY_FAILED, "Could not reserve the Wormhole Potion");
    add(TpaFeedback.TELEPORT_FAILED, "Teleport failed; no success was reported");
    add(TpaFeedback.STATE_UNKNOWN, "Teleport state could not be verified; contact an administrator");
    add(TpaFeedback.ROLLBACK_FAILED, "Teleport failed and potion recovery needs administrator attention");
    ...
    // Reward | 击杀奖励
    add(RewardFeedback.SUCCESS, "Mob Reward: %s %s");
    add(RewardFeedback.BALANCE_LIMIT, "Your balance cannot receive the complete mob reward");
    add(
        RewardFeedback.TRANSACTION_FAILED,
        "The mob reward could not be saved; no reward was paid");
    add(
        RewardFeedback.STATE_UNKNOWN,
        "The mob-reward state could not be verified; contact an administrator");
    add(StarterKitFeedback.SUCCESS, "Starter kit claimed: %s DreamingFish Coins");
    add(StarterKitFeedback.ALREADY_CLAIMED, "You have already claimed the starter kit");
    add(StarterKitFeedback.BALANCE_LIMIT, "Your balance cannot receive the complete starter-kit reward");
    add(StarterKitFeedback.PERSIST_FAILED, "The starter kit could not be saved; no reward was kept");
    add(StarterKitFeedback.STATE_UNKNOWN, "Starter-kit state could not be verified; contact an administrator");
    add(UpdateFeedback.AVAILABLE, "A new version is available: %s");
    add(UpdateFeedback.CURRENT, "EconomySystem is up to date");
    add(UpdateFeedback.UNAVAILABLE, "Could not check for EconomySystem updates");
    add(UpdateFeedback.INVALID_RESPONSE, "The EconomySystem update response was invalid");
    ...
    add("message.mailbox.toast.title", "New mail");
    add("message.mailbox.toast.body", "%s · %s");
    ...
    add(RedPacketFeedback.ALREADY_ACTIVE, "Red Packet Already Active");
    add(RedPacketFeedback.CREATED, "Red Packet Created Successfully");
    add(RedPacketFeedback.NO_AVAILABLE, "Red Packet No Available");
    add(RedPacketFeedback.ALREADY_CLAIMED, "Red Packet Already Claimed");
    add(RedPacketFeedback.CLAIM_SUCCESS, "Red Packet Claim Success: %s %s");
    add(RedPacketFeedback.CLAIM_BUTTON, "Red Packet Claim Button");
    add(RedPacketFeedback.CLAIM_HOVER, "Click to claim this red packet");
    add(RedPacketFeedback.BROADCAST, "Red Packet Broadcast: %s");
    add(RedPacketFeedback.NO_ACTIVE, "Red Packet No Active");
    add(RedPacketFeedback.CANCELLED, "Red packet cancelled; %s DreamingFish Coins were refunded");
    add(RedPacketFeedback.FULLY_CLAIMED, "Red Packet Fully Claimed: %s");
    add(RedPacketFeedback.EXPIRED_REFUNDED, "Red Packet Expired Refunded: %s");
    add(RedPacketFeedback.EXPIRED_BROADCAST, "Red Packet Expired Broadcast: %s");
    add(RedPacketFeedback.CLAIM_BROADCAST, "Red Packet Claim Broadcast: %s %s %s");
    add(RedPacketFeedback.BALANCE_LIMIT, "The complete red-packet payment would exceed the balance limit");
    add(RedPacketFeedback.TRANSACTION_FAILED, "The red-packet transaction could not be saved; no partial change was kept");
    add(RedPacketFeedback.STATE_UNKNOWN, "The red-packet state could not be verified; contact an administrator");
