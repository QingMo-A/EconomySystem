...
/** NeoForge 1.21.1 shell for the common personal commission center. */
public final class NeoForge1211CommissionCenterScreen extends Screen {
  ...
  public NeoForge1211CommissionCenterScreen() { this(null); }
  public NeoForge1211CommissionCenterScreen(Screen parent) {
  ...
  @Override public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
    CommissionCenterLayout.Layout layout = CommissionCenterLayout.calculate(width, height,
        controller.state(), new NeoForge1211UiTextMetrics(font));
