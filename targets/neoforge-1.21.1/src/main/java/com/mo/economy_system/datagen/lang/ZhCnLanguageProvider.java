...
public class ZhCnLanguageProvider extends LanguageProvider {
  ...
  protected void addTranslations() {
    ...
    add(Util_MessageKeys.HOME_DELIVERY_BOX_BUTTON_KEY, "邮箱");
    ...
    add("screen.home.leaderboard.self", "%s (你)");
    ...
    add("screen.shop.purchase.balance", "余额：%s");
    add("screen.shop.purchase.capacity", "可容纳：%s");
    ...
    add("screen.shop.purchase.insufficient_balance", "梦鱼币余额不足");
    ...
    add("screen.market.sort.default", "默认");
    add("screen.market.sort.unit_asc", "单价↑");
    add("screen.market.sort.unit_desc", "单价↓");
    add("screen.market.sort.newest", "最新");
    add("screen.market.sort.expiring", "即将过期");
    add("screen.market.card.unit_price", "单价 %s");
    add("screen.market.card.summary", "×%s · 总价 %s");
    add("screen.market.admin_remove", "管理移除");
    add("screen.market.detail.title", "订单详情");
    add("screen.market.detail.remaining", "剩余数量：%s");
    add("screen.market.detail.unit_price", "单价：%s");
    add("screen.market.detail.order_total", "剩余总价：%s");
    add("screen.market.detail.seller", "卖家：%s");
    add("screen.market.detail.requester", "求购者：%s");
    add("screen.market.detail.buy_facts", "余额 %s · 空间 %s");
    add("screen.market.detail.deliver_facts", "持有 %s · 可收款 %s");
    add("screen.market.detail.trade_id", "订单：%s");
    add("screen.market.detail.quantity", "交易数量");
    add("screen.market.detail.all", "全部");
    add("screen.market.detail.trade_total", "本次总价：%s");
    add("screen.market.detail.expected_income", "预计获得：%s");
    add("screen.market.detail.invalid_quantity", "请输入有效数量");
    add("screen.market.detail.whole_order_only", "旧订单仅支持整单交易");
    add("screen.market.detail.order_invalidated", "订单已失效或已成交");
    add("screen.market.detail.price_overflow", "本次交易金额过大");
    add("screen.market.detail.insufficient_balance", "梦鱼币余额不足");
    add("screen.market.detail.inventory_full", "背包空间不足");
    add("screen.market.detail.insufficient_items", "持有物品数量不足");
    add("screen.market.detail.balance_limit", "余额接近上限，无法收取本次款项");
    ...
    add("screen.market.create.price", "单价");
    add("screen.market.create.total_preview", "预计总价：%s");
    ...
    add("screen.market.create.invalid_price", "请输入正整数单价");
    add("screen.market.create.price_overflow", "订单总价过大");
    ...
    add(Util_MessageKeys.DELIVERY_BOX_CLAIM_BUTTON_KEY, "领取附件");
    add(Util_MessageKeys.DELIVERY_BOX_ITEM_NAME_AND_COUNT_KEY, "%s x %s");
    add("screen.delivery_box.search", "搜索邮箱");
    add("screen.delivery_box.esc", "按 ESC 返回");
    add("screen.delivery_box.loading", "正在加载邮箱...");
    add("screen.delivery_box.empty", "邮箱为空");
    add("screen.delivery_box.empty_hint", "玩家邮件、系统通知和市场退回都会显示在这里");
    add("screen.delivery_box.sync_failed", "邮箱加载失败");
    add("screen.delivery_box.sync_timeout", "邮箱请求超时");
    add("screen.delivery_box.retry", "重试");
    add("screen.mailbox.category.all", "全部");
    add("screen.mailbox.category.unread", "未读");
    add("screen.mailbox.category.market", "市场");
    add("screen.mailbox.category.system", "系统");
    add("screen.mailbox.category.player", "玩家");
    add("screen.mailbox.category.announcement", "公告");
    add("screen.mailbox.category_empty", "此分类暂无邮件");
    add("screen.mailbox.category_empty_hint", "切换其他分类，或等待新的邮件到达");
    add("screen.mailbox.sender.market", "发件人：市场系统");
    add("screen.mailbox.sender.system", "发件人：系统");
    add("screen.mailbox.sender.player", "发件人：玩家");
    add("screen.mailbox.sender.compensation", "发件人：系统补偿");
    add("screen.mailbox.sender.announcement", "发件人：系统公告");
    add("screen.mailbox.subject.market_return", "市场订单物品退回");
    add("screen.mailbox.subject.market_demand_fulfilled", "求购订单已交付");
    add("screen.mailbox.subject.system_delivery", "系统物品邮件");
    add("screen.mailbox.subject.player_delivery", "玩家物品邮件");
    add("screen.mailbox.subject.compensation", "系统补偿");
    add("screen.mailbox.subject.announcement", "系统公告");
    add("screen.mailbox.body.market_return", "你的市场订单已经结束，未处理的物品已作为附件退回。");
    add("screen.mailbox.body.market_demand_fulfilled", "求购物品已由交付者发送至邮件附件，请领取附件。");
    add("screen.mailbox.body.system_delivery", "系统向你发送了一份物品附件。");
    add("screen.mailbox.body.player_delivery", "其他玩家向你发送了一份物品附件。");
    add("screen.mailbox.body.compensation", "你收到了一份系统补偿。");
    add("screen.mailbox.body.announcement", "系统发布了一则公告。");
    add("screen.mailbox.attachments", "附件（%s）");
    add("screen.mailbox.source", "来源：%s");
    add("screen.mailbox.compose", "写邮件");
    add("screen.mailbox.compose.title", "写邮件");
    ...
    add("screen.mailbox.claim_short", "领");
    add("screen.mailbox.claim_all", "领取全部");
    add("screen.mailbox.delete", "删除邮件");
    add("screen.mailbox.dismiss", "隐藏公告");
    add("message.mailbox.delete.has_attachments", "邮件仍有未领取附件，无法删除");
    add("message.mailbox.claim_all.success", "已领取 %s 个附件");
    add("message.mailbox.new_mail", "你收到了一封来自 %s 的新邮件");
    add("message.mailbox.toast.title", "新邮件");
    add("message.mailbox.toast.body", "%s · %s");
    add("message.mailbox.send.success", "邮件发送成功");
    add("message.mailbox.send.recipient_not_found", "找不到该玩家");
    add("message.mailbox.send.cannot_send_to_self", "不能给自己发送邮件");
    add("message.mailbox.send.invalid_content", "邮件内容无效");
    add("message.mailbox.send.invalid_attachment", "附件已变化，请重新选择");
    ...
    add(Util_MessageKeys.MARKET_REMOVE_SALES_MAILBOX_FULL, "原所有者邮箱附件空间已满");
    add(Util_MessageKeys.MARKET_REMOVE_SALES_MAILBOX_FAILED, "商品退回邮箱失败，订单未下架");
    add(Util_MessageKeys.MARKET_REMOVE_SALES_MAILBOX_STATE_UNKNOWN, "邮箱写入状态不确定，请刷新并确认后再重试");
    ...
    add("message.market.purchase.whole_only", "该旧订单价格无法精确拆分，只能整单购买");
    ...
    add("message.market.deliver_demand.whole_only", "该旧求购单价格无法精确拆分，只能整单交付");
    add("message.market.deliver_demand.mailbox_full", "求购者邮箱或附件空间已满，暂时无法交付");
    add("message.market.deliver_demand.mailbox_failed", "求购物品写入邮箱失败，交易已回滚");
    ...
    add("message.market.expired.sales_return", "你的出售单 %s x%s 已过期，物品已移入邮箱");
    add("message.market.expired.demand_refunded", "你的求购单 %s 已过期，已退回 %s 枚梦鱼币");
    add("message.market.expired.demand_delivered", "已交付的求购物品 %s x%s 已过期，物品已移入邮箱");
