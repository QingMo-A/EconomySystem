...
public class SupporterHat extends ArmorItem {
    public static final String SUPPORTER_UUID_KEY = CosmeticProfilePolicy.SUPPORTER_UUID_KEY;
    public static final String SUPPORTER_NAME_KEY = CosmeticProfilePolicy.SUPPORTER_NAME_KEY;
    ...
    public static Optional<UUID> getSupporterUuid(ItemStack stack) {
        ...
        return CosmeticProfilePolicy.parseUuid(tag.getString(SUPPORTER_UUID_KEY));
    }
    ...
    public static void setSupporter(ItemStack stack, UUID supporterUuid, String supporterName) {
        ...
        tag.putString(SUPPORTER_NAME_KEY,
