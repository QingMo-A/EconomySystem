...
/** NeoForge shell for the common received-artifact and terminal transfer views. */
final class Screen_CheckedFileTransferResult extends Screen {
  ...
  public void tick() {
    ...
    var artifact = NeoForge1211ClientFileCheckClientRuntime.transfers().completedArtifact();
