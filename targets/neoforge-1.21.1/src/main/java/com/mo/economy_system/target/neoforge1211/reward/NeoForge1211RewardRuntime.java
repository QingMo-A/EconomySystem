package com.mo.economy_system.target.neoforge1211.reward;
...
/** NeoForge API adapter for the common mob-reward service. */
public final class NeoForge1211RewardRuntime {
  ...
  private NeoForge1211RewardRuntime() {}

  public static synchronized RewardService service(MinecraftServer server) {
    Objects.requireNonNull(server, "server");
    ensureConfiguration();
    return SERVICES.computeIfAbsent(server, NeoForge1211RewardRuntime::createService);
  }
