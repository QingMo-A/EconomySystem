...
public class Util_MessageKeys {
  public static final String MARKET_DELIVER_DEMAND_SUCCESS =
      "message.market.deliver_demand.success";
  public static final String MARKET_DELIVER_DEMAND_FAILED = "message.market.deliver_demand.failed";
  public static final String MARKET_DELIVER_DEMAND_REQUESTER_NOTICE =
  ...
  public static final String COIN_COMMAND_INSUFFICIENT_BALANCE =
      "message.coin_command_insufficient_balance";
  public static final String COIN_COMMAND_SET = "message.coin_command_set";
  public static final String TRANSFER_SUCCESSFULLY_MESSAGE_KEY =
      "message.transfer.transfer_successfully";
  public static final String RECEIVE_SUCCESSFULLY_MESSAGE_KEY =
      "message.transfer.receive_successfully";
  ...
  // Recall Potion | 回忆药水
  public static final String RECALL_POTION_ERROR_DIMENSION_NOT_FOUND =
  ...
  public static final String SHOP_ITEM_FLUCTUATION_FACTOR_KEY =
      "screen.shop.item.fluctuation_factor";
  ...
  public static final String SHOP_BUY_FAILED_INVENTORY_FULL_MESSAGE_KEY =
      "message.shop.buy_failed_inventory_full";
  ...
  public static final String SHOP_BUY_INVENTORY_INSUFFICIENT_TEXT_KEY =
      "text.shop_buy.inventory_insufficient";
  ...
  public static final String MARKET_SWITCH_DISPLAY_TYPE_0_BUTTON_KEY =
      "button.market.switch_display_type_0";
  public static final String MARKET_SWITCH_DISPLAY_TYPE_1_BUTTON_KEY =
      "button.market.switch_display_type_1";
  public static final String MARKET_SWITCH_DISPLAY_TYPE_2_BUTTON_KEY =
      "button.market.switch_display_type_2";
  public static final String MARKET_SWITCH_DISPLAY_TYPE_3_BUTTON_KEY =
      "button.market.switch_display_type_3";
  public static final String MARKET_SWITCH_DISPLAY_TYPE_4_BUTTON_KEY =
      "button.market.switch_display_type_4";
  ...
  public static final String MARKET_ITEM_DOES_NOT_EXIST_MESSAGE_KEY =
      "message.market.item_does_not_exist";
  public static final String MARKET_PURCHASE_FAILED_MESSAGE_KEY = "message.market.purchase_failed";
  public static final String MARKET_PURCHASE_SUCCESSFULLY_MESSAGE_KEY =
      "message.market.purchase_successfully";
  ...
  public static final String MARKET_UNMATCHED_SELLER_MESSAGE_KEY =
      "message.market.unmatched_seller";
  public static final String MARKET_ITEM_HAS_BEEN_RETURNED_MESSAGE_KEY =
      "message.market.item_has_been_returned";
  ...
  public static final String LIST_INSUFFICIENT_ITEM_MESSAGE_KEY =
      "message.list.list_insufficient_item";
  public static final String LIST_UNMATCHED_ITEM_MESSAGE_KEY = "message.list.list_unmatched_item";
  public static final String LIST_ITEM_TAX_PAYMENT_FAILED_MESSAGE_KEY =
      "message.list.list_item_tax_payment_failed";
  public static final String LIST_INVALID_QUANTITY_MESSAGE_KEY = "message.list.invalid_quantity";
  public static final String LIST_UNSUPPORTED_ITEM_DATA_MESSAGE_KEY =
      "message.list.unsupported_item_data";
  ...
  public static final String REQUEST_QUANTITY_EXCEEDS_LIMIT =
      "message.request.quantity_exceeds_limit";
  ...
  public static final String REQUEST_CANCEL_ROLLBACK_FAILED =
      "message.request.cancel_rollback_failed";
  ...
  public static final String DELIVERY_BOX_ITEM_NAME_AND_COUNT_KEY =
      "screen.delivery_box.item.name_and_count";

  // RedPacket Command | 红包指令
  public static final String RED_PACKET_INSUFFICIENT_BALANCE =
      "message.red_packet.insufficient_balance";
  public static final String RED_PACKET_ALREADY_ACTIVE = "message.red_packet.already_active";
  public static final String RED_PACKET_CREATED_SUCCESSFULLY =
      "message.red_packet.created_successfully";
  ...
  public static final String TERRITORY_TERRITORY_OWNER_NAME_KEY =
      "screen.territory.territory_owner_name";
  public static final String TERRITORY_TERRITORY_OWNER_UUID_KEY =
      "screen.territory.territory_owner_name_uuid";
  public static final String TERRITORY_TERRITORY_BACK_POINT_KEY =
      "screen.territory.territory_back_point";
  public static final String TERRITORY_TERRITORY_NO_AUTHORIZED_PLAYER_KEY =
      "screen.territory.territory_no_authorized_player";

  // Screen_ManageTerritory | 管理领地
  public static final String TERRITORY_MANAGEMENT_COPY_ID = "message.territory_management.copy_id";
  public static final String TERRITORY_MANAGEMENT_INVITE_PLAYER =
      "message.territory_management.invite_player";
  public static final String TERRITORY_MANAGEMENT_DELETE_TERRITORY =
      "message.territory_management.delete_territory";
  public static final String TERRITORY_MANAGEMENT_COPY_SUCCESS =
      "message.territory_management.copy_success";
  public static final String TERRITORY_MANAGEMENT_KICK_PLAYER =
      "message.territory_management.kick_player";
  public static final String TERRITORY_MANAGEMENT_BUFF = "message.territory_management.buff";
  public static final String TERRITORY_MANAGEMENT_PERMISSIONS =
      "message.territory_management.permissions";
  public static final String TERRITORY_MANAGEMENT_TRANSFER_OWNERSHIP =
      "message.territory_management.transfer_ownership";
  ...
  public static final String TERRITORY_BUFF_TEXT_BE_LOCKED_TEXT_KEY =
      "text.territory_buff.be_locked";
  public static final String TERRITORY_BUFF_TEXT_BE_UNLOCKED_TEXT_KEY =
      "text.territory_buff.be_unlocked";
  public static final String TERRITORY_BUFF_TOOLTIP_BUFF_ID_TEXT_KEY =
      "tooltip.territory_buff.buff_id";
  public static final String TERRITORY_BUFF_TOOLTIP_BUFF_NAME_TEXT_KEY =
      "tooltip.territory_buff.buff_name";
  public static final String TERRITORY_BUFF_TOOLTIP_BUFF_CURRENT_LEVEL_TEXT_KEY =
      "tooltip.territory_buff.buff_current_level";
  public static final String TERRITORY_BUFF_TOOLTIP_BUFF_MAX_LEVEL_TEXT_KEY =
      "tooltip.territory_buff.buff_max_level";
  public static final String TERRITORY_BUFF_TOOLTIP_BUFF_EFFECT_ID_TEXT_KEY =
      "tooltip.territory_buff.buff_effect_id";
  public static final String TERRITORY_BUFF_TOOLTIP_BUFF_UNLOCK_STATE_KEY =
      "tooltip.territory_buff.buff_unlock_state";
  ...
  public static final String TERRITORY_BUFF_MESSAGE_BUFF_MAX_LEVEL_KEY =
      "message.territory_buff.buff_max_level";
  public static final String TERRITORY_BUFF_MESSAGE_REQUIREMENT_ITEM_FAIL_KEY =
      "message.territory_buff.requirement_item_fail";
  public static final String TERRITORY_BUFF_MESSAGE_REQUIREMENT_XP_LEVEL_FAIL_KEY =
      "message.territory_buff.requirement_xp_level_fail";
  ...
  public static final String CLAIM_WAND_FIRST_POSITION_SET =
      "message.claim_wand.first_position_set";
  public static final String CLAIM_WAND_SECOND_POSITION_SET =
  ...
  public static final String CLAIM_RESIZE_INSUFFICIENT_BALANCE =
  ...
  public static final String CLAIM_WAND_RESIZE_COST_DETAILS =
  ...
  public static final String MARKET_PURCHASE_INSUFFICIENT_FUNDS =
      "message.market.purchase.insufficient_funds";
  public static final String MARKET_PURCHASE_SELLER_BALANCE_LIMIT =
      "message.market.purchase.seller_balance_limit";
  public static final String MARKET_PURCHASE_INVENTORY_FULL =
      "message.market.purchase.inventory_full";
  public static final String MARKET_PURCHASE_ORDER_CHANGED =
      "message.market.purchase.order_changed";
  public static final String MARKET_PURCHASE_PERSIST_FAILED =
  ...
  public static final String MARKET_PURCHASE_PAYMENT_FAILED =
      "message.market.purchase.payment_failed";
  public static final String MARKET_PURCHASE_ROLLBACK_FAILED =
      "message.market.purchase.rollback_failed";
  public static final String MARKET_PURCHASE_FAILED = "message.market.purchase.failed";
  public static final String MARKET_PURCHASE_SELLER_NOTICE =
  ...
  public static final String MARKET_REMOVE_SALES_NOT_FOUND =
      "message.market.remove_sales.not_found";
  public static final String MARKET_REMOVE_SALES_WRONG_TYPE =
      "message.market.remove_sales.wrong_type";
  public static final String MARKET_REMOVE_SALES_NOT_OWNER =
      "message.market.remove_sales.not_owner";
  public static final String MARKET_REMOVE_SALES_OWNER_OFFLINE =
  ...
  public static final String MARKET_REMOVE_SALES_ITEM_FAILED =
      "message.market.remove_sales.item_failed";
  public static final String MARKET_REMOVE_SALES_ROLLBACK_FAILED =
  ...
  public static final String MARKET_REMOVE_SALES_OPERATOR_NOTICE =
      "message.market.remove_sales.operator_notice";
  public static final String MARKET_CONFIRM_DEMAND_SUCCESS =
      "message.market.confirm_demand.success";
  public static final String MARKET_CONFIRM_DEMAND_NOT_FOUND =
      "message.market.confirm_demand.not_found";
  public static final String MARKET_CONFIRM_DEMAND_WRONG_TYPE =
      "message.market.confirm_demand.wrong_type";
  public static final String MARKET_CONFIRM_DEMAND_NOT_DELIVERED =
      "message.market.confirm_demand.not_delivered";
  public static final String MARKET_CONFIRM_DEMAND_NOT_OWNER =
      "message.market.confirm_demand.not_owner";
  public static final String MARKET_CONFIRM_DEMAND_OWNER_OFFLINE =
      "message.market.confirm_demand.owner_offline";
  public static final String MARKET_CONFIRM_DEMAND_INVENTORY_FULL =
      "message.market.confirm_demand.inventory_full";
  public static final String MARKET_CONFIRM_DEMAND_ORDER_CHANGED =
      "message.market.confirm_demand.order_changed";
  public static final String MARKET_CONFIRM_DEMAND_PERSIST_FAILED =
      "message.market.confirm_demand.persist_failed";
  public static final String MARKET_CONFIRM_DEMAND_ITEM_FAILED =
      "message.market.confirm_demand.item_failed";
  public static final String MARKET_CONFIRM_DEMAND_ROLLBACK_FAILED =
  ...
  public static final String MARKET_CONFIRM_DEMAND_OPERATOR_NOTICE =
