...
- Protocols 23-25 lifecycle hardening is complete. Connection generations invalidate scans and queued UI/network
  ...
  Verified counts: 317 shared-source, 393 Forge, 453 NeoForge. Protocol 26+ is legacy.
