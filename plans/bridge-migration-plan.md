...
- 验证套件包含 Forge 1.20.1 195 项测试和 NeoForge 1.21.1 196 项测试。
...
- Protocol 14 `DELIVER_DEMAND_ORDER` is migrated; next is protocol 16.
- Protocol 14 hardening is closed: authoritative requester reporting, expected-order transition,
  ...
  coverage are complete. Protocol 16 remains legacy.
