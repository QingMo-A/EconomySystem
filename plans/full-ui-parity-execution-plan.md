...
- Final XML totals are Forge 877 tests / 0 failures / 0 errors / 1 skip and NeoForge 942 tests / 0 failures / 0 errors / 1 skip. `buildAllTargets --no-daemon --rerun-tasks` passed. No blocked followups remain.
...
scaling/anchor gate. All common and target renderer implementations are
