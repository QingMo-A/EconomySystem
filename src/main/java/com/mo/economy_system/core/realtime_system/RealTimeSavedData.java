...
public class RealTimeSavedData extends SavedData {
    ...
    public static RealTimeSavedData load(CompoundTag tag, HolderLookup.Provider registries) {
    ...
    public static RealTimeSavedData getInstance(ServerLevel level) {
        ...
        return overworld.getDataStorage().computeIfAbsent(new SavedData.Factory<>(RealTimeSavedData::new, RealTimeSavedData::load), DATA_NAME);
    }
}
