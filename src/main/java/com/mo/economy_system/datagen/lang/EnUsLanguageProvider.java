...
public class EnUsLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("enchantment.economy_system.carefully.desc", "Increases the amount of currency found on bodies");
        ...
        // Recall Potion | 回忆药水
        add(Util_MessageKeys.RECALL_POTION_ERROR_DIMENSION_NOT_FOUND, "Recall Potion Error Dimension Not Found");
        ...
        add(Util_MessageKeys.SHOP_BUY_FAILED_INVENTORY_FULL_MESSAGE_KEY, "Shop Buy Failed Inventory Full");
        ...
        add(Util_MessageKeys.MARKET_PURCHASE_SUCCESSFULLY_MESSAGE_KEY, "Market Purchase Successfully: %s %s %s");
        ...
        add(Util_MessageKeys.MARKET_ITEM_HAS_BEEN_RETURNED_MESSAGE_KEY, "Market Item Has Been Returned");
        ...
        add(Util_MessageKeys.LIST_ITEM_TAX_PAYMENT_FAILED_MESSAGE_KEY, "List Item Tax Payment Failed: %s");
        ...
        add(Util_MessageKeys.DELIVERY_BOX_ITEM_NAME_AND_COUNT_KEY, "Delivery Box Item Name And Count: %s %s");
        ...
        add(Util_MessageKeys.TERRITORY_TERRITORY_BACK_POINT_KEY, "Territory Territory Back Point: %s %s %s");
        add(Util_MessageKeys.TERRITORY_TERRITORY_NO_AUTHORIZED_PLAYER_KEY, "Territory Territory No Authorized Player");
        ...
        add(Util_MessageKeys.TERRITORY_MANAGEMENT_DELETE_TERRITORY, "Territory Management Delete Territory");
        ...
        add(Util_MessageKeys.TERRITORY_MANAGEMENT_TRANSFER_OWNERSHIP, "Territory Management Transfer Ownership");
        add(Util_MessageKeys.TERRITORY_MANAGEMENT_RESIZE_TERRITORY, "Territory Management Resize Territory");
        ...
        add(Util_MessageKeys.TERRITORY_SETBACKPOINT_NO_PERMISSION, "Territory Setbackpoint No Permission");
        add(Util_MessageKeys.TERRITORY_SETBACKPOINT_SUCCESS, "Territory Setbackpoint Success: %s %s %s");
        ...
        add(Util_MessageKeys.CLAIM_WAND_SECOND_POSITION_SET, "Claim Wand Second Position Set: %s %s %s");
        ...
        add(Util_MessageKeys.CLAIM_WAND_RESIZE_COST_DETAILS, "Claim Wand Resize Cost Details: %s %s %s");
        ...
        add(Util_MessageKeys.MARKET_REMOVE_SALES_ROLLBACK_FAILED, "Rollback needs administrator attention");
        ...
        add(Util_MessageKeys.MARKET_CONFIRM_DEMAND_NOT_DELIVERED, "This demand order has not been delivered");
        ...
        add(Util_MessageKeys.MARKET_CONFIRM_DEMAND_INVENTORY_FULL, "The owner's main inventory is full");
        add(Util_MessageKeys.MARKET_CONFIRM_DEMAND_ORDER_CHANGED, "The order changed; please retry");
        add(Util_MessageKeys.MARKET_CONFIRM_DEMAND_PERSIST_FAILED, "Could not persist the market change");
        add(Util_MessageKeys.MARKET_CONFIRM_DEMAND_ITEM_FAILED, "Could not restore the delivered item");
        add(Util_MessageKeys.MARKET_CONFIRM_DEMAND_ROLLBACK_FAILED, "Rollback needs administrator attention");
