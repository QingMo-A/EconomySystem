...
public class a1111_Screen extends EconomySystem_Screen {
    ...
    private static List<Component> buildItemTooltip(Player player, MarketItem item) {
        List<Component> tooltipLines = new ArrayList<>(item.getItemStack().getTooltipLines(net.minecraft.world.item.Item.TooltipContext.of(player.level()), player,
    ...
    private static Component buildItemTooltip(Player player, ShopItem item) {
        List<Component> lines = new ArrayList<>(item.getItemStack().getTooltipLines(net.minecraft.world.item.Item.TooltipContext.of(player.level()), player,
                Minecraft.getInstance().options.advancedItemTooltips ?
                        TooltipFlag.ADVANCED : TooltipFlag.NORMAL
        ));
