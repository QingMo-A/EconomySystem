...
public class Packet_DeathScreenData {
    ...
    public Packet_DeathScreenData(float respawnPoint, float normalCost, float keepInventoryCost, boolean isInfected, Component deathMessage) {
    ...
    public static Packet_DeathScreenData decode(FriendlyByteBuf buf) {
        ...
        return new Packet_DeathScreenData(respawnPoint, normalCost, keepInventoryCost, isInfected, deathMessage);
    }
    ...
    private static class ClientHandler {
        static void handle(Packet_DeathScreenData packet) {
            ...
            com.mo.economy_system.core.playerattributes_system.death.DeathScreenDataStorage.setData(
                packet.respawnPoint,
                packet.normalCost,
