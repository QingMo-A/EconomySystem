...
public final class TerritoryTestFixtures {
  ...
  public static Summary summary(UUID id, UUID owner, String name) {
    return new Summary(id, owner, "领主", name, new Position(1, 64, 2),
  ...
  public static Owned owned() {
    ...
    Buff buff = new Buff("economy:speed", "速度 增益", "minecraft:speed", false, 0, 1, 3,
        true, 2, List.of(
    ...
    return new Owned(summary(UUID.fromString("10000000-0000-0000-0000-000000000001"), OWNER, "家园"),
        List.of(new Member(UUID.fromString("20000000-0000-0000-0000-000000000001"), "成员甲"),
  ...
  public static TerritoryDataResponseMessage response(long requestId) {
    return new TerritoryDataResponseMessage(requestId, List.of(owned()), List.of(
        summary(UUID.fromString("30000000-0000-0000-0000-000000000001"), UUID.randomUUID(), "朋友领地")));
  }
}
