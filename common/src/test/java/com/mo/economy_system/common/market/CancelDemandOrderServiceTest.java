...
class CancelDemandOrderServiceTest {
    ...
    @Test void refundFailureRestoresOrderAndRollbackFailureIsExplicit(){Fixture rejected=new Fixture();rejected.account.creditResult=BalanceMutationResult.BALANCE_LIMIT;assertEquals(CancelDemandOrderResult.OWNER_BALANCE_LIMIT,rejected.execute());assertNotNull(rejected.repository.order);
